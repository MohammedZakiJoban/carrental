...
if (isset($_GET['edit'])){
    ...
    $mysql_qry = " select * FROM users LEFT OUTER JOIN customer ON users.id = customer.user_id where users.id = $id;";
...
<body>
  ...
  <div class = "container">
    <?php
    require_once 'config.php';
    $sql_qry = " select * FROM users LEFT OUTER JOIN customer ON users.id = customer.user_id where users.role_id = 2;";
...
<table class = 'table'>
    ...
    while ($row = $result->fetch_assoc()):?>
        <tr>
            ...
            <td>
                <a href = "customerlist.php?edit=<?php  echo $row['id'];?>" class = 'btn1 btn-info'>Edit</a>
                <a href = "editCustomer.php?delete=<?php  echo $row['id'];?>" class = 'btn1 btn-danger'>Delete</a>
